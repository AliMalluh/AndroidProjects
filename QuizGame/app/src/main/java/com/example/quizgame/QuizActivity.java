    ...
    public void game()
    {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(QuizActivity.this, "You answered all questions", Toast.LENGTH_LONG).show();
                }
            }
        ...
        databaseReferenceSecond.child("scores").child(userUID).child("correct").setValue(userCorrect)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(QuizActivity.this, "scores sent successfully", Toast.LENGTH_LONG).show();
                    }
                });
